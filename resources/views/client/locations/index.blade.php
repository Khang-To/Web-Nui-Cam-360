...
@section('content')
    ...
    @php
        // Banner cho trang Danh thắng
        $bgImage = '/images/hero-background/danh-thang-banner.jpg'; // fallback mặc định

        if (isset($bannerLocations) && $bannerLocations) {
            $bgImage = asset('storage/' . $bannerLocations->image_path);
        }
    @endphp

    <section class="d-flex align-items-center"
        style="height: 100%; min-height: 600px; background: linear-gradient(rgba(27, 94, 32, 0.8), rgba(0, 0, 0, 0.5)), url('{{ $bgImage }}') center/cover no-repeat; margin-top: 0;">
        <div class="container text-center pt-5">
            <span class="text-uppercase fw-bold text-warning mb-2 d-block" style="letter-spacing: 2px;"
                data-aos="fade-down">Điểm Đến</span>
            ...
            <p class="lead text-light mx-auto px-3" style="max-width: 600px;" data-aos="fade-up" data-aos-delay="200">
                Hành trình chiêm bái những thắng tích tâm linh và cảnh sắc kỳ vĩ không thể bỏ lỡ tại Thiên Cấm Sơn.
            </p>
        </div>
    </section>
