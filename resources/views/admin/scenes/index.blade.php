                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="{{ route('admin.scenes.hotspots', $scene) }}"
                                    class="btn btn-sm btn-info text-nowrap d-inline-flex align-items-center gap-1">
                                ...
                                <form action="{{ route('admin.scenes.destroy', $scene) }}" method="POST" class="d-inline"
                                    onsubmit="return confirm('Bạn có chắc muốn xóa scene này?')">
                                    @csrf
                                    @method('DELETE')
